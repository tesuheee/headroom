...
リリースバイナリは Windows 10/11 互換性を優先し、.NET Framework 4.8 を対象にしています。
Windows 10 22H2 と Windows 11 には .NET Framework 4.8 以上が含まれます。
ソースからビルドする場合は .NET Framework 4.8 Developer Pack、または .NET Framework 4.8
targeting pack を含む Visual Studio Build Tools が必要です。
